...
public class textFieldNoOrdenController implements KeyListener{
    
    private final textFieldNoOrden textField;

    public textFieldNoOrdenController(textFieldNoOrden textField) {
    ...
    private boolean validarFormato(String texto){
        ...
        if(texto.equals("NA")) return true;
