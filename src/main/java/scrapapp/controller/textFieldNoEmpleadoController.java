...
public class textFieldNoEmpleadoController implements KeyListener{
    
    private final textFieldNoEmpleado textField;
    
    public textFieldNoEmpleadoController(textFieldNoEmpleado textField){
